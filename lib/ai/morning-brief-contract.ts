...
const RECOMMENDATION_LANGUAGE = /(?:建议|可|宜|应|值得|推荐)(?:买入|卖出|加仓|减仓|关注|持有|低吸)|(?:逢低|逢高)(?:吸纳|买入|卖出|减仓)|(?:买点|卖点|低吸|仓位(?:建议|配置|管理)?|收益承诺|目标价|止损|止盈|重仓|满仓|清仓|建仓|抄底|追高)/;
...
const INVESTMENT_ACTION_LANGUAGE = /买入|卖出|加仓|减仓|低吸|布局|配置|建仓|清仓|止损|止盈|吸纳|持有|持仓|空仓|仓位|轻仓|重仓|满仓|半仓|观望|降低持仓|提高持仓|抄底|追高/;
