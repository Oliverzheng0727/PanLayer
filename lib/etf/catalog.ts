...
export const ETF_CATEGORIES = [
  "全部", "宽基指数", "科技AI", "半导体存储", "机器人制造", "医药医疗", "美容护理",
  "新能源", "汽车", "消费农业", "金融", "军工", "资源周期", "红利策略", "港股",
  "海外指数", "商品", "债券货币", "其他",
] as const;
...
const rules: Array<{ category: Exclude<EtfCategory, "全部" | "其他">; pattern: RegExp; tags: string[] }> = [
  ...
  { category: "科技AI", pattern: /科技|人工智能|AI|算力|云计算|计算机|软件|通信|5G|大数据|互联网/, tags: ["科技", "AI", "算力", "通信"] },
  { category: "消费农业", pattern: /消费|食品|饮料|白酒|家电|农业|畜牧|养殖|旅游|传媒|游戏/, tags: ["消费", "农业"] },
  { category: "金融", pattern: /银行|证券|券商|保险|金融|房地产/, tags: ["金融", "银行", "证券"] },
  { category: "军工", pattern: /军工|国防|航空|航天|卫星/, tags: ["军工", "航空航天"] },
  { category: "商品", pattern: /黄金|白银|原油|豆粕|商品|有色金属期货/, tags: ["商品"] },
  { category: "资源周期", pattern: /有色|煤炭|钢铁|化工|稀土|能源|资源|石油|矿业/, tags: ["资源", "周期"] },
