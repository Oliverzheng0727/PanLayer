...
export default async function DashboardPage() {
  ...
  return <Dashboard review={demoReview} brief={demoBrief} etfs={demoEtfs} history={demoHistory} highDetailsByDate={demoHighDetailsByDate} userName={user.displayName} />;
}
